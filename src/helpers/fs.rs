...
(
	...
	action_on_right_click_media_player_metadata:    ShowMediaPlayerWindow,
    ...
    (
        ...
        window_size:                  (340, 500),
        window_padding:               18,
        background_color:             HEX("1c1c1c"),
        background_border_color:      HEX("3d3d3d"),
        background_border_size:       1.0,
        background_border_radius:     (16.0, 16.0, 16.0, 16.0),

        // ── Layout ───────────────────────────────────────────────────────
        row_order:                    [Fill, Prev, PlayPause, Next, Fill],
        row_height:                   54,
        row_spacing:                  14,
        section_spacing:              18,
        ...
        metadata_text_color:          HEX("ffffff"),
        metadata_max_chars:           80,
        metadata_button_style:
        (
            color:                  RGBA((0, 0, 0, 0)),
            hovered_color:          RGBA((0, 0, 0, 0)),
        ...
        (
            color:                  RGBA((0, 0, 0, 0)),
            hovered_color:          HEX("2b2b2b"),
            pressed_color:          HEX("1c1c1c"),
            text_color:             HEX("d8d8d8"),
            hovered_text_color:     HEX("ffffff"),
            pressed_text_color:     HEX("a1a1a1"),
            border_color:           RGBA((0, 0, 0, 0)),
            border_size:            0.0,
        ...
        (
            color:                  HEX("ffffff"),
            hovered_color:          HEX("e6e6e6"),
            pressed_color:          HEX("cfcfcf"),
            text_color:             HEX("1c1c1c"),
            hovered_text_color:     HEX("1c1c1c"),
            pressed_text_color:     HEX("1c1c1c"),
            border_color:           RGBA((0, 0, 0, 0)),
            border_size:            0.0,
            border_radius:          (20.0, 20.0, 20.0, 20.0),
            gradient_color:         Some(Gradient((180.0, [(0.0, HEX("ffffff")), (1.0, HEX("d0d0d0"))]))),
            hovered_gradient_color: Some(Gradient((180.0, [(0.0, HEX("ffffff")), (1.0, HEX("dedede"))]))),
            pressed_gradient_color: None,
        ),
        pause_button_style:
        (
        ...
        show_album_art:               true,
        album_art_size:               260,
        album_art_border_radius:      (14.0, 14.0, 14.0, 14.0),
        album_art_border_color:       HEX("3d3d3d"),
        album_art_border_size:        1.0,
        album_art_spacing:            18,
        album_art_placeholder_color:  HEX("2b2b2b"),
        album_art_position:           Top,

        // ── Progress bar ─────────────────────────────────────────────────
        progress_bar_height:          4,
        progress_bar_filled_color:    HEX("ffffff"),
        progress_bar_track_color:     HEX("3d3d3d"),
        progress_bar_border_color:    RGBA((0, 0, 0, 0)),
        progress_bar_border_size:     0.0,
        progress_bar_border_radius:   (2.0, 2.0, 2.0, 2.0),
        ...
        volume_bar_height:             4,
        volume_bar_filled_color:       HEX("ffffff"),
        volume_bar_track_color:        HEX("3d3d3d"),
        volume_bar_border_color:       RGBA((0, 0, 0, 0)),
        volume_bar_border_size:        0.0,
        volume_bar_border_radius:      (2.0, 2.0, 2.0, 2.0),
        volume_bar_clickable:          true,
        volume_bar_label_format:       Some("{vol}%"),
        volume_bar_label_position:     Right,
        volume_bar_label_size:         12,
        volume_bar_label_color:        HEX("a1a1a1"),
