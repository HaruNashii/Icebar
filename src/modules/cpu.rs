...
pub fn define_cpu_style(app: &AppData, status: button::Status) -> iced::widget::button::Style
{
    ...
    {
        status,
        normal_text:        cfg.cpu_text_color,
        hovered_text:       cfg.cpu_button_hovered_text_color,
        pressed_text:       cfg.cpu_button_pressed_text_color,
        ...
        shadow_blur:        cfg.cpu_button_shadow_blur
    })
}
